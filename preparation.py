...
def generate_unique_ID_for_each_genre():
    ...
    """
    input_file = 'data_w_genres.csv'
    output_file = 'genres_with_ids.csv'
...
def generate_artist_genre_mapping():
    ...
    """
    input_file = 'data_w_genres.csv'
    output_file = 'artist_genre_mapping.csv'
...
def process_music_data(file_path, mapping_file, output_file):
    ...
    columns_to_drop = ['Unnamed: 0', 'lyrics', 'dating', 'age', 'len', 'topic']
...
process_music_data('music_1950_2019.csv', 'artist_genre_mapping.csv', 'final_processed_music_data.csv')
